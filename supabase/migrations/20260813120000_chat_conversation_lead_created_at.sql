-- O filtro "Lead chegou" (hoje/ontem/data) no Chat sempre dava vazio: a RPC
-- list_chat_conversations, usada no carregamento padrao da lista (sem busca
-- nem filtro de status), nunca retornava a data de criacao do lead. O filtro
-- no client dependia desse campo e recebia sempre null.
...
as $function$
  ...
  select
    ...
    l.quality_stars as lead_quality_stars,
