-- Adiciona quality_stars ao retorno de list_chat_conversations, pra permitir
-- filtro por qualidade do lead no Chat (igual ja existe no Kanban/Ligacoes).
-- Precisa dropar antes: mudar o tipo de retorno (colunas OUT) nao e permitido
