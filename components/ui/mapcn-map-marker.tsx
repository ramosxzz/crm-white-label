...
// maplibre-gl v6 nao tem mais default export, e os tipos de style spec sairam
// do pacote principal pro @maplibre/maplibre-gl-style-spec.
...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-popover text-popover-foreground relative max-w-[15.5rem] rounded-md border p-3 shadow-md",
