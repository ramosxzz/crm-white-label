...
export function LoginShowcase({ children }: { children: ReactNode }) {
  ...
  return (
    <Dialog>
        ...
        <section id="inicio" className="relative min-h-screen overflow-hidden px-5 pb-20 pt-28 sm:px-8 lg:px-12 lg:pb-24 lg:pt-32">
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-[1240px] flex-col items-center">
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
              ...
              <DialogTrigger asChild>
                <button type="button" className="h-11 border border-white/15 bg-white/[0.04] px-5 text-sm font-semibold text-white transition-colors hover:border-white/30 hover:bg-white/[0.08]">
                  Já sou cliente
                </button>
              </DialogTrigger>
            </div>
      ...
      <DialogContent className="max-h-[92vh] w-[calc(100%-2rem)] max-w-[430px] overflow-y-auto border-white/12 bg-[#090b11] p-6 text-white shadow-[0_34px_100px_rgba(0,0,0,.72)] sm:p-8">
        {children}
      </DialogContent>
    </Dialog>
  );
